...
let ProductController = class ProductController extends BaseController_1.BaseController {
    async searchProducts(req, res, searchKeyword) {
        try {
            if (!searchKeyword) {
...
__decorate([
    ...
    __param(2, (0, routing_controllers_1.QueryParam)('searchKeyword')),
...
exports.ProductController = ProductController = __decorate([
    ...
    (0, routing_controllers_1.JsonController)("/api/product")
], ProductController);
